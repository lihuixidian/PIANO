...
extern "C" int InsertGraph(bool isTest, const int g_id, const int num_nodes, const int num_edges, const int* edges_from, const int* edges_to);//weight
...
extern "C" double GetSol_test(const int gid, int* sol);
#endif